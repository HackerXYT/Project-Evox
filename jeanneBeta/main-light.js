    ...
    navigator.serviceWorker.addEventListener('message', event => {
        ...
        switch (event.data?.type) {
            ...
            case 'CACHE_START':
                ...
                document.getElementById("update-center").style.setProperty("display", "flex", "important");
                document.getElementById("update-center").classList.add("active");
                break;
...
function createPost(el, dontClear) {
    ...
    document.getElementById("createPostSvg").querySelector("path").style.fill = "#fff" //Dont change to variable
    setTimeout(function () {
        setupPersonalInfo()
            .then(() => {
                ...
                document.getElementById("createPostSvg").querySelector("path").style.fill = "var(--bar-text-color)"
        ...
        .then(progress_global => {
            ...
            Object.entries(progress_class.class_counts).forEach(([key, value]) => {
                ...
                document.getElementById("classes").innerHTML += `<div class="aclass">
                    ...
                    <div class="right">
                        ${key === 'ΓΥΓ' ? `<svg xmlns="http://www.w3.org/2000/svg" fill="var(--color-theme)" width="25px" height="25px" viewBox="0 0 32 32" version="1.1">
<title>health</title>
...
<path d="M5 6.2C5 5.07989 5 4.51984 5.21799 4.09202C5.40973 3.71569 5.71569 3.40973 6.09202 3.21799C6.51984 3 7.07989 3 8.2 3H15.8C16.9201 3 17.4802 3 17.908 3.21799C18.2843 3.40973 18.5903 3.71569 18.782 4.09202C19 4.51984 19 5.07989 19 6.2V21L12 16L5 21V6.2Z" stroke="var(--color-theme)" stroke-width="2" stroke-linejoin="round"/>
                        ...
                        ${block && semicount === 1 ? `<div style='z-index: 9999;position:absolute;width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px;gap:10px;color: var(--descriptive-color-2);'>
        ...
        document.getElementById("sentToSelectedUser").innerHTML = html === "" ? `<div style='z-index: 9999;position:absolute;width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px;gap:10px;color: var(--descriptive-color-2);'>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 -0.5 17 17" version="1.1" class="si-glyph si-glyph-deny"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <path d="M9.016,0.06 C4.616,0.06 1.047,3.629 1.047,8.029 C1.047,12.429 4.615,15.998 9.016,15.998 C13.418,15.998 16.985,12.429 16.985,8.029 C16.985,3.629 13.418,0.06 9.016,0.06 L9.016,0.06 Z M3.049,8.028 C3.049,4.739 5.726,2.062 9.016,2.062 C10.37,2.062 11.616,2.52 12.618,3.283 L4.271,11.631 C3.508,10.629 3.049,9.381 3.049,8.028 L3.049,8.028 Z M9.016,13.994 C7.731,13.994 6.544,13.583 5.569,12.889 L13.878,4.58 C14.571,5.555 14.982,6.743 14.982,8.028 C14.981,11.317 12.306,13.994 9.016,13.994 L9.016,13.994 Z" fill="#ff481bc5" class="si-glyph-fill">
                        </path></g></svg>
...
<path d="M5 6.2C5 5.07989 5 4.51984 5.21799 4.09202C5.40973 3.71569 5.71569 3.40973 6.09202 3.21799C6.51984 3 7.07989 3 8.2 3H15.8C16.9201 3 17.4802 3 17.908 3.21799C18.2843 3.40973 18.5903 3.71569 18.782 4.09202C19 4.51984 19 5.07989 19 6.2V21L12 16L5 21V6.2Z" stroke="var(--color-theme)" stroke-width="2" stroke-linejoin="round"/>
                    ...
                    ${index === 0 ? `<div style='z-index: 9999;position:absolute;width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px;gap:10px;color: var(--descriptive-color-2);'>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 -0.5 17 17" version="1.1" class="si-glyph si-glyph-deny"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <path d="M9.016,0.06 C4.616,0.06 1.047,3.629 1.047,8.029 C1.047,12.429 4.615,15.998 9.016,15.998 C13.418,15.998 16.985,12.429 16.985,8.029 C16.985,3.629 13.418,0.06 9.016,0.06 L9.016,0.06 Z M3.049,8.028 C3.049,4.739 5.726,2.062 9.016,2.062 C10.37,2.062 11.616,2.52 12.618,3.283 L4.271,11.631 C3.508,10.629 3.049,9.381 3.049,8.028 L3.049,8.028 Z M9.016,13.994 C7.731,13.994 6.544,13.583 5.569,12.889 L13.878,4.58 C14.571,5.555 14.982,6.743 14.982,8.028 C14.981,11.317 12.306,13.994 9.016,13.994 L9.016,13.994 Z" fill="#ff481bc5" class="si-glyph-fill">
                        </path></g></svg>
...
function searchByInput() {
    ...
    if (complete.length === 0 && el.value.length >= 2) {
        document.getElementById("searchedUsers").innerHTML = `<div id="temp-load-indi-search" style="display:flex;flex-direction:column;width:100%;align-items:center;gap:5px;justify-content:center;"><svg xmlns="http://www.w3.org/2000/svg" fill="var(--color-theme)" width="25px" height="25px" viewBox="0 0 32 32" version="1.1">
                ...
                .then(progress_global => {
                    ...
                    classes.forEach((klasa, index) => {
                        ...
                        <div class="title-button-section">
                            ${key === 'ΓΥΓ' ? `<svg xmlns="http://www.w3.org/2000/svg" fill="var(--color-theme)" width="20px" height="20px" viewBox="0 0 32 32" version="1.1">
<title>health</title>
<path d="M29.125 10.375h-7.5v-7.5c0-1.036-0.839-1.875-1.875-1.875h-7.5c-1.036 0-1.875 0.84-1.875 1.875v7.5h-7.5c-1.036 0-1.875 0.84-1.875 1.875v7.5c0 1.036 0.84 1.875 1.875 1.875h7.5v7.5c0 1.036 0.84 1.875 1.875 1.875h7.5c1.036 0 1.875-0.84 1.875-1.875v-7.5h7.5c1.035 0 1.875-0.839 1.875-1.875v-7.5c0-1.036-0.84-1.875-1.875-1.875z"/>
