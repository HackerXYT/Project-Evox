        ...
        .then(status => {
            ...
            if(status.message === 'Verification Started') {
                ...
                EvalertNext({
                    ...
                    "description": "Το email που εισάγατε χρησιμοποιείται ήδη από άλλο λογαριασμό.<br>Παρακαλώ χρησιμοποιήστε ένα διαφορετικό email.",
                    "buttons": ["Συνέχεια"],
                    "buttonAction": ["document.getElementById('voxEmail-input').value = ''"],
                    "addons": []
                })
